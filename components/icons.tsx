...
export const SparklesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6.225 15.225L5 14l-1.225 1.225M17.775 15.225L19 14l1.225 1.225M12 21v-4M21 12h-4M7 12H3M12 3v4M3 5h4M12 21v-4m0-11a4.002 4.002 0 00-4 4c0 1.615.672 3.075 1.76 4.162M12 6a4.002 4.002 0 014 4c0 1.615-.672 3.075-1.76 4.162" />
  </svg>
);
